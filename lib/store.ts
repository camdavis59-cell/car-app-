...
const SEED_GARAGE: GarageCar[] = [
  { id: "g1", year: 2020, make: "Nissan", model: "370Z", color: "Magnetic Black", horsepower: "332", engine: "3.7L V6 DOHC", transmission: "6-Speed Manual", drivetrain: "RWD", weight: "3,291 lbs", description: "My daily driver and weekend warrior. Built for canyon runs and car meets. Track-aligned suspension.", mods: ["Stillen cat-back exhaust","KW V3 coilovers","Work VS-XX 19\" wheels","Nismo front lip & rear diffuser","Berk HFC headers"], photos: ["https://picsum.photos/seed/car1a/600/400","https://picsum.photos/seed/car1b/600/400","https://picsum.photos/seed/car1c/600/400"] },
  { id: "g2", year: 1994, make: "Toyota", model: "Supra", color: "Super White", horsepower: "600", engine: "2JZ-GTE Inline-6 Twin Turbo (built)", transmission: "6-Speed Manual (Getrag)", drivetrain: "RWD", weight: "3,450 lbs", description: "Long-term build. 600whp on E85. Daily driven carefully. This car stops traffic everywhere it goes.", mods: ["2JZ-GTE engine swap","Precision 6766 single turbo","ID1050x injectors","Haltech Elite 2500 ECU","Volk TE37SL 18\" wheels","StopTech big brake kit"], photos: ["https://picsum.photos/seed/car2a/600/400","https://picsum.photos/seed/car2b/600/400"] },
];
